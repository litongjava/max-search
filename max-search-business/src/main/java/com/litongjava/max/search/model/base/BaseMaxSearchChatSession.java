package com.litongjava.max.search.model.base;
...
public abstract class BaseMaxSearchChatSession<M extends BaseMaxSearchChatSession<M>> extends Model<M> implements IBean {
