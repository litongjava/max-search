...
@Slf4j
public class SearchPerplexiticySeeCallback implements Callback {
  private ChannelContext channelContext;
  private String chatId;
  private String quesitonMessageId;
  private long start;

  public SearchPerplexiticySeeCallback(ChannelContext channelContext, String sessionId, String messageId, long start) {
